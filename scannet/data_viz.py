...
scene_name = 'scannet_train_detection_data/'+ sys.argv[1]
...
pc_util.write_ply_rgb(scene_points, colors, os.path.join(output_folder, sys.argv[1]+'.obj'))
pc_util.write_ply_color(scene_points, instance_labels, os.path.join(output_folder, sys.argv[1]+'_instance.obj'))
pc_util.write_ply_color(scene_points, semantic_labels, os.path.join(output_folder, sys.argv[1]+'_semantic.obj'))
