...
def make_args_parser():
    ...
    parser.add_argument("--hard_anchor", default=True, action="store_true")
    ...
    ##### Dataset #####
    parser.add_argument(
        "--dataset_name", required=True, type=str, choices=["scannet", "sunrgbd","arkitscenes"], default="scannet"
    )
    parser.add_argument(
        "--dataset_root_dir",
        type=str,
    ...
    parser.add_argument("--use_color", default=True, action="store_true") 
    parser.add_argument("--xyz_color", default=True, action="store_true") 
    ...
    parser.add_argument("--out_obj_dir", default="relu", type=str)
